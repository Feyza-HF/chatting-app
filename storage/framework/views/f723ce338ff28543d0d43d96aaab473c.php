...
<body>
  ...
  <section class="profile-container">
    <div class="profile">
      <div class="home-img">
        <img src="<?php echo e(asset('image/jett.jpg')); ?>" alt="Feyza's Photo" />
      </div>
      <div class="home-text">
    ...
    <div class="profile">
      <div class="home-img">
        <img src="<?php echo e(asset('image/dimas.jpg')); ?>" alt="Dimas's Photo" />
      </div>
      <div class="home-text">
...
<?php /**PATH C:\laragon\www\chatfeyzadimas\resources\views/welcome.blade.php ENDPATH**/ ?>